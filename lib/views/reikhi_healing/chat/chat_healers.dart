...
class ChatHealersScreen extends StatefulWidget {
  const ChatHealersScreen({super.key});

  @override
  State<ChatHealersScreen> createState() => _ChatHealersScreenState();
}

class _ChatHealersScreenState extends State<ChatHealersScreen> {
